/* global govbrIsDarkMode, setTimeout */

// Check the color scheme preference and inject the classes if necessary.
if ( document.body.classList.contains( 'govbr-supports-dark-theme' ) ) {
	govbrDarkModeEditorInit();
}
 ...
 * @return {void}
 */
function govbrDarkModeEditorInit( attempt ) {
	...
	if ( govbrIsDarkMode() ) {
		if ( null === container ) {
			...
			if ( attempt < maxAttempts ) {
				setTimeout(
					function() {
						govbrDarkModeEditorInit( attempt + 1 );
					},
