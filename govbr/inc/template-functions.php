 ...
 * @return string
 */
function gov_br_get_non_latin_css( $type = 'front-end' ) {
	...
	$font_family = apply_filters(
		'gov_br_get_localized_font_family_types',
		array(
	...
	$elements = apply_filters(
		'gov_br_get_localized_font_family_elements',
		array(
	...
	if ( ! function_exists( 'gov_br_generate_css' ) ) {
	...
	return gov_br_generate_css( // @phpstan-ignore-line.
