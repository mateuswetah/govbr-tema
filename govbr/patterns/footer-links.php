...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"0","bottom":"0","right":"var:preset|spacing|scale-up-5","left":"var:preset|spacing|scale-up-5"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group" style="padding-top:0;padding-right:var(--wp--preset--spacing--scale-up-5);padding-bottom:0;padding-left:var(--wp--preset--spacing--scale-up-5)"><!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|scale-up-6","bottom":"var:preset|spacing|scale-up-4"}}},"className":"logo","layout":{"type":"flex","flexWrap":"nowrap"}} -->
...
<div class="wp-block-govbr-collapse-label br-item header" data-toggle="collapse" data-target="brgov-collapse--f4514252-a046-4a11-b15e-ad948a053776"><div class="content"><div class="flex-fill"><?php _e('A list of links', 'govbr') ?></div><div class="support"><i class="fas fa-angle-down fa-chevron-down" aria-hidden="true" aria-label="Expand/Collapse"></i></div></div></div>
...
<div class="wp-block-govbr-collapse-label br-item header" data-toggle="collapse" data-target="brgov-collapse--9d03aef0-9cb5-40cb-b8c2-de64a658e2d0"><div class="content"><div class="flex-fill"><?php _e('Website categories', 'govbr') ?></div><div class="support"><i class="fas fa-angle-down fa-chevron-down" aria-hidden="true" aria-label="Expand/Collapse"></i></div></div></div>
<!-- /wp:govbr/collapse-label -->
...
<div class="wp-block-govbr-collapse-label br-item header" data-toggle="collapse" data-target="brgov-collapse--262fdfc9-e2aa-4bce-87e6-cd73515c0737"><div class="content"><div class="flex-fill"><?php _e('Latest posts', 'govbr') ?></div><div class="support"><i class="fas fa-angle-down fa-chevron-down" aria-hidden="true" aria-label="Expand/Collapse"></i></div></div></div>
<!-- /wp:govbr/collapse-label -->
